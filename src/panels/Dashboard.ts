    ...
    constructor() {
        ...
        this.devices = [ [
                ...
                new ActionMultiDevice("Ogrzewanie parter", [
                    ...
                    { title: "Kuchnia", sensor: "1.6.1", sensor1: "10.20.3", sensor2: "c.10.20.4", type: ActionMultiSensorType.Heater },
                    { title: "Schody", sensor: "1.2.1", sensor1: "10.20.5", sensor2: "c.10.20.1", type: ActionMultiSensorType.Heater },
                    { title: "Jadalnia", sensor: "1.5.1", sensor1: "10.20.2", sensor2: "c.10.20.3", type: ActionMultiSensorType.Heater },
                    { title: "Salon (taras)", sensor: "1.4.1", sensor1: "10.20.1", sensor2: "c.10.20.6", type: ActionMultiSensorType.Heater },
                ...
                new ActionMultiDevice("Ogrzewanie piętro", [
                    ...
                    { title: "P1", sensor: "2.4.1", sensor1: "10.20.18", sensor2: "c.10.20.11", type: ActionMultiSensorType.Heater },
                    { title: "P2", sensor: "2.5.1", sensor1: "10.20.19", sensor2: "c.10.20.12", type: ActionMultiSensorType.Heater },
                    { title: "Łazienka", sensor: "2.6.1", sensor1: "10.20.20", sensor2: "c.10.20.13", type: ActionMultiSensorType.Heater },
                    { title: "Bawialnia", sensor: "2.7.1", sensor1: "10.20.21", sensor2: "c.10.20.14", type: ActionMultiSensorType.Heater },
                    { title: "Pralnia", sensor: "2.8.1", sensor1: "10.20.22", sensor2: "c.10.20.15", type: ActionMultiSensorType.Heater },
